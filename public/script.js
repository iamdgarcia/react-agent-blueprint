// ReAct Agent Frontend JavaScript
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add a reasoning step to the reasoning panel
    function addReasoningStep(type, content) {
        const stepDiv = document.createElement('div');
        stepDiv.classList.add('reasoning-step', `type-${type}`);
    ...
    async function sendMessage() {
        ...
        try {
            // Call the agent API
            const response = await fetch('/.netlify/functions/react-agent', {
                method: 'POST',
                headers: {
            ...
            addReasoningStep('error', error.message);
        } finally {
            // Re-enable input
    ...
    // Add welcome message
    addMessage('Hello! I am a ReAct (Reasoning + Acting) Agent. I can help you with questions, calculations, and more. Try asking me something like: "What is the weather in Tokyo?", "Calculate 15 * 23", or "Search for information about machine learning."', 'assistant');
});